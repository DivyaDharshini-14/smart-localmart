...
export default function Checkout() {
    return (
        <VegefoodsLayout title="Checkout - Vegefoods" activePage="shop" breadcrumbTitle="Checkout">
                                        ...
                                        <div className="form-group">
                                            <div className="col-md-12">
                                                <div className="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="" className="mr-2" /> I have read and accept the terms and conditions
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
